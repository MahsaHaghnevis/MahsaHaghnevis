...
👋 Hi there! I'm **Mahsa Haghnevis**, a passionate **Bakcend** developer with expertise in **Swift**, **C++**, **Python** , **JS** and exploring **Devops** concepts . 


### What I Do
- 🔭 **iOS Development**: I am crafting efficient applications for the Apple ecosystem .
- 🖥️ **Back-End with JavaScript**: Building RESTful APIs using **Node.js**, **Express**, and connecting them to databases like **MongoDB**.
- 🧩 **C++ & Python**: Applying strong problem-solving skills in algorithm development and system design . 
- 🎓 **Constant Learning**: Backend architecture · API design · deployment · clean code.
...
### Skills
- 💻 **Programming Languages**: Swift, C++, Python,JS , Node.js
- 🛠 **Tools & Technologies**: Xcode, Unity, figma, Git , Postman
